...
<html>
    <head>
        ...
        <style>
        body{
            background-color: rgb(122, 143, 139);
            font-family: cursive;
        }
            #runnerfeeling{
                font-family: cursive ;
            ...
            #runner{
               ...
               height: 501px; 
               overflow-y: auto;
               border: 7px solid rgb(0, 166, 217);
               padding:32px;               
               left: -29px;
            }
            #traveler{
                background-color: rgb(213, 245, 221);
                font-family: cursive;
                width: 326px;
                height: 500px;
                position: relative;
                ...
                top:-47px;
                overflow: auto;
                border: 7px solid rgb(112, 237, 29);
                padding: 35px;
            }
            #engineer{
                ...
                overflow-y: auto;
                font-family: cursive;
                border: 8px solid rgb(252, 47, 99);
                padding: 26px;
            }
            #end{
                position: relative;
